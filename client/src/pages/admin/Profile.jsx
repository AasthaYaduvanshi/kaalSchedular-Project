  ...
  return (
    <Container>
      <Grid
        container
        spacing={2}
        sx={{ minHeight: "500px", alignItems: "center" }}
      >
        <Grid item xs={12} md={6}>
          ...
          <Typography
            variant="body1"
            sx={{ fontSize: { xs: "1rem", sm: "1.25rem", md: "1.0rem" } }}
          >
            Why do you use the making time table by itself It's 2024 , try it by
            using our advanced algorithms.{" "}
          </Typography>
          <SubmitButton
            onClick={() => {
              info ? nav("/user/profile") : nav("/signup")
            }}
            variant="contained"
